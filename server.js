...
// MODIFICADO: Validación de transferencia
app.post('/api/pedidos', (req, res) => {
    try {
        ...
        // Validar que si es transferencia, exista número de tarjeta configurado
        if (metodoPago === 'Transferencia') {
            ...
            if (!numeroTarjeta || numeroTarjeta.trim() === '') {
                return res.status(400).json({ 
                    ...
                    mensaje: 'Esta tienda no tiene configurado el número de tarjeta para transferencias. Contacte al administrador.'
                });
            }
        }
        ...
        console.log(`✅ Pedido #${nuevoPedido.id} creado para tienda: ${tienda} | Código: ${codigoCliente}`);
        res.json({ 
            success: true, 
